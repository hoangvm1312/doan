...
class CafeController extends Controller
{
    ...
    public function showBancafe($khuvuc_id){
        ...
        return view('pages.cafe')->with('all_khuvuc',$all_khuvuc)->with('all_bancafe',$all_bancafe)->with('loaisanpham_id',$loaisanpham_id)->with('tongban',$tongban)->with('tongphong',$tongphong);
    }    
}
