...
<div class="col-md-6" id="table-list">
                <div class="row list-filter">
                        <div class="col-md list-filter-content">
                            @if(isset($all_loaiphong)) <!-- Hiển thị loại phòng -->
                    ...
                    <div class="row table-list">
                        <div class="col-md table-list-content">
                            <ul> 
                                @if(isset($all_phong)) <!-- Hiển thị phòng -->
                                    @foreach($all_phong as $key=>$phong) 
                                        <form  method="post">
                                            <li
                                                ...
                                                ?>
                                            > 
                                                <a href="{{URL::to('/karaoke-select-product/'.$phong->phong_id.'/'.$loaisanpham_id)}}" class='button-select'>{{$phong->phong_name}}</a>
                                            </li>
                                        </form>
                                    @endforeach            
                                @endif   
